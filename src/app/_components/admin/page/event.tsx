...
import EditModalBtn from "../modal-btn/event/update";
import { useCallback } from "react";
import AddModalBtn from "../modal-btn/event/add";

export default function Page(){

    const { data:event , error ,isLoading} = trpc.event.gets.useQuery()
    ...
    return (
        <div className="w-full">
            ...
            :<TableBody isLoading={isLoading} items={event}  loadingContent={<Spinner />}>
                 {(item) => (
